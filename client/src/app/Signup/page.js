...
const Signup = () => {
  ...
  return (
<section className="bg-gradient-to-r from-blue-500 to-indigo-600 py-10">
  <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
    <form className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg" onSubmit={SubmitForm}>
      ...
      <div className="mt-6">
        <button
          className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-indigo-600 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
          type="Submit"
        >
          Sign Up
        </button>
